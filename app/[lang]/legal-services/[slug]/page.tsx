        ...
        <div className="min-h-screen bg-[#F4F7FB]">
            ...
            <div className="relative bg-gradient-to-br from-[#003d7a] via-[#005CB9] to-[#0070db] overflow-hidden pt-44 pb-20">
                ...
                <div className="container mx-auto px-4 md:px-8 relative z-10">
                    <Link href="/legal-services" className="inline-flex items-center gap-2 text-blue-200 hover:text-white text-sm font-medium mb-8 group transition-colors">
                        ...
                        {sidebarAreas.length > 0 && (
                            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8">
                                ...
                                <div className="mt-8 pt-6 border-t border-gray-100">
                                    <Link href="/legal-services" className="inline-flex items-center justify-center w-full gap-2 text-sm font-bold text-[#005CB9] hover:text-[#003d7a] transition-colors bg-blue-50/50 hover:bg-blue-50 py-3 rounded-xl">
