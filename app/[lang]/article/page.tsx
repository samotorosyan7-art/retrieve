...
function Pagination({ currentPage, totalPages, t }: { currentPage: number; totalPages: number; t: any }) {
    ...
    return (
        ...
        >
            {/* Prev */}
            <Link
                href={currentPage > 1 ? `/article?page=${currentPage - 1}` : "#"}
            ...
            {/* Next */}
            <Link
                href={currentPage < totalPages ? `/article?page=${currentPage + 1}` : "#"}
...
export default async function ArticlePage({
    ...
    const { posts, total, totalPages } = await getArticles(PER_PAGE, currentPage, lang);
        ...
        <div className="min-h-screen bg-[#F4F7FB]">
            ...
            <div className="container mx-auto px-4 md:px-8 pt-36 pb-6">
                ...
                <div className="relative bg-gradient-to-br from-[#003D7A] via-[#005CB9] to-[#0070DB] rounded-[2rem] overflow-hidden shadow-xl py-16 px-6 md:py-24 md:px-12 text-center text-white">
                    ...
                    <div className="max-w-[52rem] mx-auto relative z-10 space-y-6">
                        ...
                        <h1 className="text-3xl md:text-[52px] font-extrabold text-white tracking-tight leading-tight max-w-[52rem] mx-auto">
                            {t.page_blog_title}
                        </h1>
