...
import { getArticleBySlug, getArticles, getArticleTags } from "@/lib/wordpress";
            ...
            <div className="container mx-auto px-4 md:px-8 pt-36 pb-6">
                ...
                <div className="relative bg-gradient-to-br from-[#003D7A] via-[#005CB9] to-[#0070DB] rounded-[2rem] overflow-hidden shadow-xl pt-8 pb-16 px-6 md:pt-10 md:pb-24 md:px-12 text-white">
                    ...
                    <Breadcrumbs className="relative z-10" items={[
                        { label: t.page_blog_title || "Insights & News", href: "/article" },
                        { label: post.title }
                    ]} />
                ...
                <div className="flex flex-col lg:flex-row gap-12 items-start">
                    ...
                    <article className="flex-1 min-w-0">
                        ...
                        <div className="mt-8 flex items-center justify-between">
                            <Link href="/article" className="inline-flex items-center gap-2 text-sm font-semibold text-gray-500 hover:text-[#005CB9] transition-colors">
                        ...
                        {sidebar.length > 0 && (
                            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                                ...
                                <div className="space-y-4">
                                    {sidebar.map((r) => (
                                        <Link key={r.id} href={`/article/${r.slug}`} className="flex gap-3 group">
